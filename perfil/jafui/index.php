    ...
    <main>
        ...
        <section id="section_conteudo">
            ...
            <section id="section_destinos">
                <?php 
                    $sqlID = "SELECT Cod_Viagem, fk_Destino_Cod_Lugar, DT_Ida, DT_Volta, Valor FROM viaja WHERE fk_Cliente_Cod_Cliente = {$_SESSION['Cod_Cliente']}";
                                    ...
                                    <div id="textos_destino_individual">
                                        ...
                                        <div id="div_centralizar_datas">
                                            <div id="div_data_ida">
                                                ...
                                                <p class="datas"><?php echo date('d/m/Y', strtotime($rowID['DT_Ida']));?></p>
                                            </div>

                                            <div id="div_data_volta">
                                                <p class="label_datas_valor">Data de volta:</p>
                                                <p class="datas"><?php echo date('d/m/Y', strtotime($rowID['DT_Volta']));?></p>
                                            </div>
                                        </div>

                                        <div id="div_valor_gasto">
                                            <p class="label_datas_valor">Valor gasto:</p>
                                            <p class="valor_gasto">R$<?php echo $rowID['Valor']?></p>
                                        </div>

                                        <img src="../../img_principais/lixeira.png" alt="<?php echo $rowID['Cod_Viagem'] ?>" id="lixeira_apagar" class="lixeira_apagar">
                                    </div>
                                </div>
                            <?php
                                }
    ...
    <div id="popup_excluir">
        ...
        <div id="titulo_div_excluir">
            ...
            <div class="popup-content_excluir">
                ...
                <form action="fui_php.php" id="form_senha" method="get">
